    ...
    return ValueListenableBuilder<Selection?>(
      ...
      builder: (_, Selection? selection, __) {
        ...
        return MobileToolbarStyle(
          ...
          child: CustomMobileToolbarWidget(
...
class CustomMobileToolbarWidget extends StatefulWidget {
  const CustomMobileToolbarWidget({
    super.key,
    required this.editorState,
    required this.toolbarItems,
  ...
  @override
  State<CustomMobileToolbarWidget> createState() =>
      CustomMobileToolbarWidgetState();
}

class CustomMobileToolbarWidgetState extends State<CustomMobileToolbarWidget>
